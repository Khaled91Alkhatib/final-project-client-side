...
function AboutUs() {
  ...
  return (
    <div className="main-layout">
      <div className='data'>
        <p className="data-title">WORK IS IN OUR DNA</p>
        ...
        <p className="paragraph-data">
          We work hard to make better product through the use of Recycled, Organic or Renewable (ROR) Product Features and Technologies.
        </p>
        <p className="paragraph-data">
        ...
        <p className="data-title">REGENERATIVE LEATHER</p>
        <p className="paragraph-data">
