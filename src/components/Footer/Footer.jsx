  ...
  return (
    <div className="footer-bar">
        ...
        <div className="all-footer-content">
          ...
          <img className='logo-footer-image' onClick={onClickLogo} src='https://res.cloudinary.com/demoshoebox/image/upload/c_thumb,w_200,g_face/v1660365841/products/important/logo-dark_ssw9ta.png' alt="logo"/>
          <div className="left-right-content">
